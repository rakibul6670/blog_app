...
class PaginationPage3 extends StatefulWidget {
  const PaginationPage3({super.key});

  @override
  State<PaginationPage3> createState() => _PaginationPage3State();
}

class _PaginationPage3State extends State<PaginationPage3> {
  //------------------- initState ----------
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Consumer<BlogProvider>(
      builder: (context, blog, child) {
        ...
        if (blog.paginationPage3.isEmpty) {
          return Center(
            child: Text(
        ...
        return RefreshIndicator(
          ...
          child: ListView.separated(
            itemCount: blog.paginationPage3.length,
            itemBuilder: (context, index) {
              //------------- blog post map ----
              final blogPost = blog.paginationPage3[index];
